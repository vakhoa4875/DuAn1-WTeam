...
public class TestCheckUser2 {

	private String username;
	private String pass;
	private String expected;

	public TestCheckUser2(String username, String pass, String expected) {
	...
	public static int sheetIndex = 0, rowIndex = 4, dataIndex = 3;
	public final static String tcID = "F-TC01-02";
	...
	public static void tearDown() {
		try {
			ExcelDealer.writeActualResult(fileName, sheetIndex, dataIndex + 2, rowIndex, actualResult.toString().trim(),
					wasSuccessfully);
		} catch (IOException e) {
